drop function if exists app_public.admin_list_users();
drop function if exists app_public.admin_delete_user(id uuid);
drop function if exists app_public.set_admin_status(id uuid, is_admin boolean);
